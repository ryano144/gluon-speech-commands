...
import input_data_gluon as input_data
import models_gluon as models
...
def main(_):
  ...
  # Save graph.pbtxt.
  net.save_params(FLAGS.model_architecture + ".params")
  ...
  for training_step in xrange(start_step, training_steps_max + 1):
    ...
    with autograd.record():
        output = net(train_fingerprints.as_in_context(ctx))
        loss = loss_function(output, train_ground_truth.as_in_context(ctx))
    loss.backward()
